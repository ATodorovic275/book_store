            ...
            <div class="row justify-content-around">
                ...
                <div class="col-sm-6 col-lg-2">
                    <div class="single_footer_part">
                        <h4>Resources</h4>
                        <ul class="list-unstyled">
                            <li><a href="https://www.linkedin.com/in/aleksandar-todorovic-67bb061a2/">Autor</a></li>
    ...
    <!-- swiper js -->
    <!-- <script src="app/js/masonry.pkgd.js"></script> -->
    <!-- particles js -->
    ...
    <!-- <script src="app/js/mail-script.js"></script> -->
    <!-- custom js -->
